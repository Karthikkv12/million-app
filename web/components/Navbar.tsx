...
export default function Navbar() {
  ...
  return (
    <>
      ...
      <aside
        className={clsx(
          "hidden lg:flex flex-col fixed top-0 left-0 h-screen border-r border-[var(--border)] bg-[var(--surface)] z-30 shrink-0 transition-[width] duration-200 ease-in-out overflow-hidden",
